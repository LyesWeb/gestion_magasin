...
import mCategories.CategorieDao;
import mCategories.CategorieDaoImpl;
import packfx.Client;
import packfx.ClientDao;
import packfx.ClientDaoImpl;

public class VenteJavaFxFormINSERT extends Application {

	public static Text messageSelect = new Text("");
...
//		window.initModality(Modality.APPLICATION_MODAL);
		...
		window.setTitle("Ajout des ventes");
            ...
            public void handle(ActionEvent t) {
            	try {
					if(clientSelected != null){
		                ...
		                double totalv = 0;
		                Vente nv = new Vente(datev, totalv, clientSelected);
		                addVente(nv);
		                VenteJavaFxVue.charger();
		                messageSelect.setText("");
	                	messageAction.setFill(Color.LIMEGREEN);
	            		messageAction.setText("Vente ajouter avec succes.");
	            	}else{
	...
	private Pane createContentTopTitle(){
		...
		Text titre = new Text(" Ajouter une vente - Liste des clients :");
