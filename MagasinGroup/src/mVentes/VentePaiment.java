...
public class VentePaiment extends Application{
	...
	private Pane createContentCenter(){
		...
		pane.getChildren().addAll(createSectionTitle("Informations de la facture :"),createVenteInfo(),createSectionTitle("Lignes de commande :"),createVenteFooter());
